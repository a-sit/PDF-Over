...
codesign -s "Developer ID Application: SIT Zentrum fuer sichere Informationstechnologie-Austria (9CYHJNG644)" -f -vvvv  --timestamp -o runtime "com/sun/jna/darwin-aarch64/libjnidispatch.jnilib"
